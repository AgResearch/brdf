# originally downloaded from http://aspn.activestate.com/ASPN/Cookbook/Python/Recipe/52273
# Title: colormap: Returns an RGB tuple on a 0 to 255 scale for graphical packages 
# Submitter: Alexander Pletzer (other recipes) 
